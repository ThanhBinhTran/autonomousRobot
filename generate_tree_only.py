...
def robot_main(start=(0, 0), goal=(0, 1), map_name=None, num_iter=1,
    ...
    if open_points_type == Robot_base.Open_points_type.RRTstar:
        ...
        rrtx_fname = rank_logger.set_logging_name_pkl(map_name=map_name, goal=goal, start=start,
        ...
        if rank_logger.is_existed_log_file(rrtx_fname):
            ...
            RRT_star = RRTree_star.load_treefile(rrtx_fname)
        else:
            ...
            RRT_star.save_treefile(rrtx_fname)
            # save ranking tree
