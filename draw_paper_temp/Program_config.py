...
show_circleGoal_HA_Assumption = False            # big circle (at goal within radius = dist(goal, robot center))
...
################################################
ls_ts = "-"         # False sight
cl_ts = "m"         # color False sight
ls_goal = "*r"      # goal
ls_start = "*b"     # start
ls_nextpt = ".r"    # next points
ls_lopt = ".r"      # local open_point
...
# the system will create 6 open points if divide_6 = False
