...
def menu_RRT():
    ...
    parser.add_argument('-m', metavar="map name", help='map name', default='_map.csv')
    ...
    parser.add_argument('-ss', metavar="sample_size", type=int, help='sample size', default=500)
    parser.add_argument('-radius', metavar="radius", type=float, help='radius', default=7.0)
    ...
    parser.add_argument('-gx', metavar="goal_x", type=float, help='goal point x', default=90.0)
