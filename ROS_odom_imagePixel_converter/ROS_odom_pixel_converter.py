...
if __name__ == "__main__":
    ...
    odom_pose = [-2, -0.5, 0]   # get from odom topic (replace this info by /odom topic)
    #odom_pose = [-3, 1, 0]      # get from odom topic (replace this info by /odom topic house)
    ...
    nxt_odom_pose = pixel_to_odom(origin_coordinate_px, resolution, nxtpt_px)
    ...
    points = np.array([ imgc_px,                 # middle pixel in image
                        ...
                        nxtpt_px,                 # move to next point in image  
                        [0,0],
                        [w,0],
                        [0,h],
                        [w,h]
