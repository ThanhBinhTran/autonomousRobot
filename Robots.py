...
def main(gx=10.0, gy=10.0, robot_type=RobotType.circle):
    ...
    while True:
        ...
        print ("________Run times:{0}, at {1}".format(run_coint, center))
        ...
        if not s_goal:
            ...
            if len(open_local_pts) > 1: # new local found
                ...
                if len(traversal_path) == 0:
                    ...
                    print ("open_local_pts: ", open_local_pts.shape, open_local_pts)
                    print ("ranks_new: ", ranks_new.shape, ranks_new)
                    ...
                    print ("ao_local_pts __+: ", ao_local_pts.shape, ao_local_pts)
                    print ("ranks_new __+ ", ranks_new.shape, ranks_new)
            ...
            traversal_path.append([center, true_sight, osight, csight]) 
            ...
            if len(ranks) > 0:
                ...
                ao_gobal= np.delete(ao_gobal, pick_idx, axis=0)
                print ("after delete", ao_gobal)
            else:
        ...
        if show_animation:
            ...
            plt.axis("equal") # make sure ox oy axises are same resolution
            plt.grid(True)
            plt.pause(0.0001)
            plt.pause(1)
