...
class Plotter(Plot_base):
    ...
    def build_tree_animation(self, num_iter, Tree, obstacles, goal_coords, start_coords, rand_coordinate=None,
                             rand_node=None,
                             neighbour_nodes=None, nearest_neighbour_node=None, color_tree=TreeColor.no):
