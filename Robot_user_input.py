...
def robot_user_input():
    ...
    parser.add_argument('-m', metavar="data_map", help='map data', default='_map_deadend.csv')
    ...
    parser.add_argument('-d', metavar="node density", type=int, help='node density', default=5)
